...
export const faqItems = Array.isArray(recordOverrides.faqItems) && recordOverrides.faqItems.length > 0 ? recordOverrides.faqItems : defaultFaqItems;
...
export const nationalAwards = Array.isArray(recordOverrides.nationalAwards) && recordOverrides.nationalAwards.length > 0 ? recordOverrides.nationalAwards : defaultNationalAwards;

const defaultProvincialAwards = [
...
export const provincialAwards = Array.isArray(recordOverrides.provincialAwards) && recordOverrides.provincialAwards.length > 0 ? recordOverrides.provincialAwards : defaultProvincialAwards;
...
export const intellectualProperty = (Array.isArray(recordOverrides.intellectualProperty) && recordOverrides.intellectualProperty.length > 0 ? recordOverrides.intellectualProperty : defaultIntellectualProperty) as typeof defaultIntellectualProperty;

const defaultAchievementSummary = [
...
export const achievementSummary = Array.isArray(recordOverrides.achievementSummary) && recordOverrides.achievementSummary.length > 0 ? recordOverrides.achievementSummary : defaultAchievementSummary;
