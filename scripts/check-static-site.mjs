...
const required = ['index.html','404.html','projects/index.html','articles/index.html','achievements/index.html','about/index.html','rss.xml','robots.txt','sitemap-index.xml','CNAME','llms.txt','site.webmanifest','favicon.svg','og-default.svg'];
